namespace CompanyHierarcgy.Models
{
    ...
    public class SalesEmployee : RegularEmployee, ISalesEmployee
    {
        ...
        public SalesEmployee(string id, string firstName, string lastName, decimal salary, Department department, ISet<Sale> sales = null) : base(id, firstName, lastName, salary, department)
        {
