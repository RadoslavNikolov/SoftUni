namespace CompanyHierarcgy.Models
{
    ...
    {
        public Developer(string id, string firstName, string lastName, decimal salary, Department department, ISet<Project> projects = null) : base(id, firstName, lastName, salary, department)
        {
