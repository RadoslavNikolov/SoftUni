namespace Scoreboard
{
    ...
    public class MyScoreboardSlow
    {
        ...
        private readonly Dictionary<string, OrderedMultiDictionary<int,string>> sortedCollection = new Dictionary<string, OrderedMultiDictionary<int, string>>(); 
        ...
        {
            var games = this.sortedCollection[gameName].Take(10);
        ...
        private string AddScore(string userName, string userPassword, string gameName, string gamePassword, string score)
        {
            ...
            {
                this.sortedCollection[gameName] = new OrderedMultiDictionary<int, string>(true);
            }
