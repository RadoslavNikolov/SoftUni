namespace TravelAgency.Models
{
    ...
    public abstract class TicketAbstract : ITicketAbstract
    {
        ...
        {
            var output = string.Format("[{0}; {1}; {2:F2}]", this.DepartureTime.ToString("dd.MM.yyyy HH:mm"), this.ExtractTicketType(),
                this.TicketPrice);
        ...
        {
            var neededResul = this.GetType().Name.Replace("Ticket", "").ToLower();
