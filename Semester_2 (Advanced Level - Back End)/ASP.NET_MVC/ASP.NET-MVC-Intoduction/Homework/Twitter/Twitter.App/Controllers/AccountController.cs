...
namespace Twitter.App.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public AccountController(ITwitterData data, UserManager userManager,  ApplicationSignInManager signInManager)
            : base(data)
        {
            ...
            try
            {
                if (this.ModelState.IsValid)
                {
                    ...
                    if (upload != null && upload.ContentLength > 0)
                    {
                        ...
                        {
                            picture.Content = render.ReadBytes(upload.ContentLength);
                        }

                        user.Files = new List<File> { picture };
                    }
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        this.TempData["success"] = new[] { "Wellcome " + model.UserName + ". You have successfully registered to this site!" };
